...
ball_m1_v = vector(0,1,2) ; ball_m2_v = vector(0,v2,0) ; ball_m3_v = vector(0,v2+v3,0)
...
while True:
    ...
    #arrow_31.axis = Fg_13_vector*0.3
    #arrow_32.pos = ball_m3.pos
    #arrow_32.axis = Fg_23_vector*0.1
    #arrow_3.pos = ball_m3.pos
    #arrow_3.axis = Fg_13_vector*0.3+Fg_23_vector*0.1
